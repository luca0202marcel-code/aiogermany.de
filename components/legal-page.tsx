  ...
  return (
    <main className="legal-shell">
      ...
      <header className="legal-header">
        ...
        <nav className="legal-tabs" aria-label="Legal-Navigation"><Link href="/legal/datenschutz">Datenschutz</Link><Link href="/legal/nutzungsbedingungen">Nutzungsbedingungen</Link></nav>
