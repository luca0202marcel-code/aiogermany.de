...
export default function UnserTeamPage() {
  return (
    <main className="team-page min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <footer className="team-page-footer relative z-10 mx-auto flex max-w-7xl flex-wrap gap-x-6 gap-y-3 px-5 pb-10 text-xs text-muted-foreground lg:px-10"><Link href="/">← Zur Startseite</Link><a href="https://team.aiogermany.de" target="_blank" rel="noreferrer">Externe Team-Seite ↗</a></footer>
    </main>
  )
}
